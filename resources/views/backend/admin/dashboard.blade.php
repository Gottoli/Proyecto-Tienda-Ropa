...
@section('title', 'Panel Admin | LISBON™')
...
<div class="container py-5">
    ...
    <h2 class="page-title" style="font-size: 2.3rem; margin-bottom: 2.5rem;">DASHBOARD</h2>
    ...
    <div class="row g-3 mb-5">
        ...
        <div class="col-md-3">
            <div class="lisbon-card" style="padding: 2rem; text-align: center;">
                <p style="letter-spacing: 0.14em; font-size: 0.85rem; color: var(--text-3); margin-bottom: 1rem;">{{ $metric['label'] }}</p>
                <h2 style="font-weight: 300; letter-spacing: 0.1em; font-size: 3.6rem; color: var(--text); margin: 0;">{{ $metric['valor'] }}</h2>
            </div>
        </div>
        @endforeach
    </div>
    ...
    <div class="row g-3">
        @foreach([
            ...
            ['titulo' => 'VENTAS',     'desc' => 'Ver métricas, órdenes y compradores',    'url' => '/admin/ventas',     'btn' => 'VER VENTAS'],
        ...
        <div class="col-md-3">
            <div class="lisbon-card" style="padding: 2rem; height: 100%;">
                <p style="letter-spacing: 4px; font-size: 0.85rem; color: var(--olive); margin-bottom: 0.6rem;">{{ $card['titulo'] }}</p>
                <p style="color: var(--text-3); font-size: 0.95rem; margin-bottom: 1.5rem;">{{ $card['desc'] }}</p>
