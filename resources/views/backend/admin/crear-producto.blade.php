...
<head>
    ...
    <title>Crear Producto - Admin Lisbon</title>
        ...
        <div class="col-md-7">
            ...
            <form action="/admin/productos" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" class="form-control mt-1" style="background: #111; border: 1px solid #333; color: #fff; border-radius: 0;">
                    @error('name') <small class="text-danger">{{ $message }}</small> @enderror
                </div>

                <div class="mb-3">
                    <label style="letter-spacing: 2px; font-size: 0.8rem; color: #aaa;">DESCRIPCIÓN</label>
                    <textarea name="description" rows="3" class="form-control mt-1" style="background: #111; border: 1px solid #333; color: #fff; border-radius: 0;">{{ old('description') }}</textarea>
                </div>

                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label style="letter-spacing: 2px; font-size: 0.8rem; color: #aaa;">PRECIO</label>
                        <input type="number" name="price" value="{{ old('price') }}" class="form-control mt-1" style="background: #111; border: 1px solid #333; color: #fff; border-radius: 0;">
                ...
                <button type="submit" class="btn w-100" style="background: #fff; color: #000; letter-spacing: 3px; border-radius: 0;">CREAR PRODUCTO</button>
            </form>
        </div>
    </div>
</div>
