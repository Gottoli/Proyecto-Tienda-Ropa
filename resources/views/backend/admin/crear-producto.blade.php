    ...
    <div class="row justify-content-center">
        <div class="col-md-7">
            ...
            <div style="margin-top: 1.5rem; margin-bottom: 2.5rem;">
                ...
                <h2 class="page-title" style="font-size: 2rem;">NUEVO PRODUCTO</h2>
            </div>
            ...
            <form action="/admin/productos" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" rows="3" class="lisbon-input" style="height: auto; resize: vertical;">{{ old('description') }}</textarea>
                </div>

                <div class="row">
                    <div class="col-md-6 mb-4">
                        <label class="lisbon-label">PRECIO</label>
                        <input type="number" name="price" value="{{ old('price') }}" class="lisbon-input">
                        @error('price') <small style="color: #8A4A3A; font-size: 0.78rem;">{{ $message }}</small> @enderror
                    </div>
                    <div class="col-md-6 mb-4">
                        <label class="lisbon-label">STOCK</label>
                        <input type="number" name="stock" value="{{ old('stock') }}" class="lisbon-input">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="talles" value="{{ old('talles') }}" placeholder="Ej: XS,S,M,L,XL" class="lisbon-input">
                ...
                <div class="mb-4">
                    ...
                    <select name="category_id" class="lisbon-input" style="appearance: none; cursor: pointer;">
                        <option value="" style="color: var(--text-3);">Seleccioná una categoría</option>
